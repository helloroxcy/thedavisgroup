...
<div class="social-bar">\
  <div class="social-bar-inner">\
    ...
    <div class="social-bar-icons">\
      <a class="social-bar-icon" href="https://www.facebook.com/profile.php?id=61572056816250&sk=directory_contact_info" target="_blank" rel="noopener" aria-label="Facebook">\
        <svg viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>\
      </a>\
      <a class="social-bar-icon" href="https://www.instagram.com/billdavishomes/" target="_blank" rel="noopener" aria-label="Instagram">\
      ...
      <a class="social-bar-icon" href="https://x.com/_thedavisgroup_" target="_blank" rel="noopener" aria-label="X">\
        <svg viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>\
      </a>\
      <a class="social-bar-icon" href="https://www.linkedin.com/in/bill-davis-b4613421/" target="_blank" rel="noopener" aria-label="LinkedIn">\
        ...
        <div class="footer-left">\
          ...
          <div class="footer-small-cols">\
            <div>\
              ...
              <p class="footer-dre">Bill Davis DRE# 01374451<br>Copyright&copy; <span id="footer-year"></span> The Davis Group<br>All Rights Reserved</p>\
            </div>\
            <div>\
